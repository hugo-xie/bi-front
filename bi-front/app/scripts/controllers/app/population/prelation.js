...
app.controller('PrelationCtrl', ['$scope','$stateParams','qService','forecastFactory',function($scope, $stateParams,qService,forecastFactory) {
    ...
    console.log(rc.data);
    var popData1=[1000,100000,100000,100000,100000,100000,100000,100000,100000,100000];
    var popData2=[1000,100000,100000,100000,100000,100000,100000,100000,100000,100000];
    var popData3=[1000,100000,100000,100000,100000,100000,100000,100000,100000,100000];

    var gdp1=[100,1000,1000,1000,1000,1000,1000,1000,1000,1000];
