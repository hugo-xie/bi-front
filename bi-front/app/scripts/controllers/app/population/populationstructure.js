...
// 使用柱状图就加载bar模块，按需加载
            ...
            function (ec) {
                ...
                var myChart = ec.init(document.getElementById('structure')); 
                
                var option = {
  
  timeline:{
        data:[
            '2015-01-01','2025-01-01','2035-01-01','2045-01-01'
        ],
        label : {
    ...
    options:[
        {
            ...
            legend : {
                x:'right',
                'data':['当前男性比例','当前女性比例','预测男性比例','预测女性比例'],
                'selected':{
                    '当前男性比例':true,
                    '当前女性比例':false,
                    '预测男性比例':true,
            ...
            series : [
                ...
                {
                    'name':'当前女性比例','yAxisIndex':1,'type':'bar',
                    'data':[100,200,300,400,100,200,300,400]
                },
                {
                    'name':'预测男性比例','yAxisIndex':1,'type':'bar',
                    'data': [100,200,300,400,100,200,300,400]
                },
                {
                    'name':'预测女性比例','yAxisIndex':1,'type':'bar',
                    'data': [100,200,300,400,100,200,300,400]
                }
            ]
        },
