...
app.controller('EconomyTaxCtrl', ['$scope','$stateParams', function($scope, $stateParams) {
  ...
  $scope.realValues = ['18.1','23.3','33.3','40.5','49.0','60.1','65.1','71.0','81.8','88.8'];
  $scope.predictionValues = ['19.3','23.0','33.6','41.5','49.7','61.1','65.6','71.7','81.8','89.8','96.5','103.5','109.1','117.7','124.9'];
  ...
  $scope.date=[193214, 230005, 336584, 416214, 523621, 625314, 688743, 743214, 813564, 892314, 965248,1052365,1128795,1234565,1310241];
